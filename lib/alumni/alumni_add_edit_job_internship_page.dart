...
class AlumniAddEditJobInternshipPage extends StatefulWidget {
  final String? docId;
  final Map<String, dynamic>? data;

  const AlumniAddEditJobInternshipPage({super.key, this.docId, this.data});

  @override
  State<AlumniAddEditJobInternshipPage> createState() =>
      _AlumniAddEditJobInternshipPageState();
}

class _AlumniAddEditJobInternshipPageState
    extends State<AlumniAddEditJobInternshipPage> {
  ...
  // 🔹 FETCH DEPARTMENT FROM ALUMNI DOC
  Future<String?> _fetchAlumniDepartment() async {
  ...
  Future<void> save() async {
    ...
    final department = await _fetchAlumniDepartment();

    if (department == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Alumni department not found')),
      );
      return;
    }
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => const AlumniManageJobInternshipPage()),
    );
  }
